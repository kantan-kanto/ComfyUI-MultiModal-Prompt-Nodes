...
from .nodes import NODE_CLASS_MAPPINGS as nNODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as nNODE_DISPLAY_NAME_MAPPINGS
...
for mappings in [nNODE_CLASS_MAPPINGS, qNODE_CLASS_MAPPINGS, wNODE_CLASS_MAPPINGS, vNODE_CLASS_MAPPINGS]:
    NODE_CLASS_MAPPINGS.update(mappings)

for mappings in [nNODE_DISPLAY_NAME_MAPPINGS, qNODE_DISPLAY_NAME_MAPPINGS, wNODE_DISPLAY_NAME_MAPPINGS, vNODE_DISPLAY_NAME_MAPPINGS]:
